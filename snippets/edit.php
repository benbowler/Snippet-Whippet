...
<select name="type" id="type" selected="<?php echo $row['type']; ?>">
...
<div class="formbg">
<b>Title</b><br /><input name="title" id="title" type="text" value="<?php echo $row['title']; ?>"/></div><br />
<div class="formbg">
<b>Content</b><br /><textarea name="content" rows="18" id="formcontent" onkeydown="return catchTab(this,event)">	<?php echo $content; ?></textarea></div><br />
<div class="formbg">
<b>Tags</b> <em class="smalltext">Separated by spaces. Make them descriptive, they're used for searching</em><br /><input name="tags" id="tags" type="text" value="<?php echo $row['tags']; ?>"/></div><br />
<div class="formbg">
...
<div class="formbg">
<input name="" type="submit" value="Submit"/></div>
</form>
